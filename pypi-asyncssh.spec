...
Source0  : https://files.pythonhosted.org/packages/9c/03/12850895815bc6d4d87e98030b016a20886343df4334681443db0234366e/asyncssh-2.15.0.tar.gz
...
%prep
%setup -q -n asyncssh-2.15.0
cd %{_builddir}/asyncssh-2.15.0
pushd ..
cp -a asyncssh-2.15.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720055302
