...
Source0  : https://files.pythonhosted.org/packages/75/85/c723aa7dd69570a31b6638c1405e659712f18f569f280da2da27989445d3/asyncssh-2.19.0.tar.gz
...
%prep
%setup -q -n asyncssh-2.19.0
cd %{_builddir}/asyncssh-2.19.0
pushd ..
cp -a asyncssh-2.19.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735093520
