...
Source0  : https://files.pythonhosted.org/packages/3e/51/647552e03b9eb73d0a456c8c01dc97ea0a1aa810288ceb2eb50eb521ba2d/asyncssh-2.12.0.tar.gz
...
%prep
%setup -q -n asyncssh-2.12.0
cd %{_builddir}/asyncssh-2.12.0
pushd ..
cp -a asyncssh-2.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666739979
