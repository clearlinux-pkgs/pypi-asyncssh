...
Source0  : https://files.pythonhosted.org/packages/e8/d6/823ed5a227f7da70b33681e49eec4a36fae31b9296b27a8d6aead2bd3f77/asyncssh-2.21.0.tar.gz
...
%prep
%setup -q -n asyncssh-2.21.0
cd %{_builddir}/asyncssh-2.21.0
pushd ..
cp -a asyncssh-2.21.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746461964
